...
<div class="col-12 border p-5 rounded" style="width: 800px"> 
    ...
    <form wire:submit="store">
        ...
        <div class="form-floating mb-5">
            <input class="form-control" wire:model.blur="price" id="price"></input>
        ...
        <div class="d-grid">
            <button class="btn btn-outline-primary rounded-5 btn-lg" type="submit">Salva</button>
        </div>
    </form>
</div>
</div>
