         ...
         <div class="col-12 col-md-9 col-lg-7 col-xl-6">
            <div class="card" style="border-radius: 15px;">
             <div class="card-body p-5">
                 <h2 class="fw-bold  mb-2  ">{{ __('authcp.message1')}}</h2>
                 <p class="fw-light">{{ __('authcp.message2')}}</p>
                    ...
                    <form action="{{ route('password.email')}}" method="POST">
                        ...
                        <div class="mb-3">
                            <label class="h5  form-label" for="email">{{ __('authcp.userEmail')}}</label>
                            ...
                            <div class="d-grid gap-2 col-6 mx-auto">
                                <button class="btn btn-dark" type="submit">{{ __('authcp.send')}}</button>
                            </div>
