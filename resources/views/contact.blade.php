                ...
                <div class="row gx-5 align-items-center justify-content-center">
                    <div class="col-lg-8 col-xl-7 col-xxl-6">
                        <div class="my-5 text-center text-xl-start">
                            <h1 class="display-5 fw-bolder mb-2">{{__('revisor.contact')}}</h1>
                            <p class="lead fw-light text-50 mb-4">{{__('revisor.insert')}}</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <form action="{{ route('send')}}" method="POST">
                ...
                <div class="row">
                        ...
                        <div class="form-floating mb-4 col">
                            ...
                            <label class="ms-2" for="name">{{__('revisor.name')}}</label>
                ...
                <div class="d-grid d-flex justify-content-center">
                    <button class="btn btn-dark rounded-3 mb-5 px-5 py-2" type="submit">{{__('revisor.send')}}</button>
                </div>
